...
stop = stopwords.words('english')+punctuation+['RT', 'rt', 'via', 'Hilary', 'Hillary', 'Clinton', 'gt', 'I', 'https', 'The', "he's", "This", "Is", "I'm", "president", "President", "J", 'get', 'hillary', 'clinton']


with open('hilary.json', 'r') as f:
